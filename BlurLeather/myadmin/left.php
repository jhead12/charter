...
<ul>
  ...
  <li><a href="javascript:;" onclick="$(this).next('ul').slideToggle(500); $(this).toggleClass('active');" class="arrow">Manage Navigation</a>
    <ul>
      <li><a href="top_navigation.php" onclick="$('[rel=sublink]').removeClass('active');$(this).addClass('active');" rel="sublink">&raquo; Manage Top Navigation</a></li>
    </ul>
  </li>
  <li><a href="javascript:;" onclick="$(this).next('ul').slideToggle(500); $(this).toggleClass('active');" class="arrow">Manage Women Section</a>
    <ul>
      ...
      <li><a href="product_banners.php?pre_category_id=2" onclick="$('[rel=sublink]').removeClass('active');$(this).addClass('active');" rel="sublink">&raquo; Product Bottom Banners</a></li>
    </ul>
  </li>
  <li><a href="javascript:;" onclick="$(this).next('ul').slideToggle(500); $(this).toggleClass('active');" class="arrow">Manage Men Section</a>
    <ul>
      ...
      <li><a href="product_banners.php?pre_category_id=3" onclick="$('[rel=sublink]').removeClass('active');$(this).addClass('active');" rel="sublink">&raquo; Product Bottom Banners</a></li>
    </ul>
  </li>
  <li><a href="javascript:;" onclick="$(this).next('ul').slideToggle(500); $(this).toggleClass('active');" class="arrow">Manage Scarf Boutique</a>
    <ul>
      ...
      <li><a href="product_banners.php?pre_category_id=4" onclick="$('[rel=sublink]').removeClass('active');$(this).addClass('active');" rel="sublink">&raquo; Product Bottom Banners</a></li>
    </ul>
  </li>
  ...
  <li><a href="javascript:;" onclick="$(this).next('ul').slideToggle(500); $(this).toggleClass('active');" class="arrow">Manage Sale Section</a>
    <ul>
      ...
      <li><a href="product_banners.php?pre_category_id=5" onclick="$('[rel=sublink]').removeClass('active');$(this).addClass('active');" rel="sublink">&raquo; Product Bottom Banners</a></li>
    </ul>
  </li>
