var JACS = new function()
    {
     ...
     document.writeln(
        '<style type="text/css">' +
            ...
            'iframe.jacs        {border:none;position:absolute;visibility:hidden;' +
     ...
     document.writeln(
        '<style type="text/css">' +
            ...
            'td.jacsWeeks                {padding:           3px;' +
                                         ...
                                         'vertical-align:    middle;}' +
            'table.jacs,' +
            'table.jacsStatic            {background-color:  #50565a;}' +
            'td.jacsDrag                 {background-color:  #9999CC;' +
                                         'color:             #CCCCFF;}' +
            'td.jacsWeekNumberHead       {color:             #50565a;}' +
            ...
            'td.jacsCellsExMonth         {background-color:  #CCCCCC;' +
                                         'color:             #666666;}' +
            'td.jacsNow                  {background-color:  #50565a;' +
                                         'color:             #FFFFFF;}' +
            ...
            'td.jacsCellsExMonthDisabled {background-color:  #999999;' +
                                         'color:             #666666;}' +
            'td.jacsNowDisabled          {background-color:  #50565a;' +
                                         'color:             #FFFFFF;}' +
        '</style>');
     function calAttributes(cal)
        {switch (cal.id)
            {case 'EnterYourIDHere':
             ...
             default:
                cal.zIndex = 1;
                cal.baseYear = dateNow.getFullYear()-60;
                cal.dropDownYears = 71;
                cal.weekStart = 1;
