...
?>script|g|<div class="content flexmainleft look">
    ...
    <div class="main">
      ...
      <div class="lookimage"> 
      	<div class="large_pan" id="pan">
        	<img id="galimg" src="<?php echo WEBSITE_URL."looks/".$look['featured_image']?>" alt="<?php echo WEBSITE_URL."looks/".$look['featured_image']?>" />
        </div>
        <ul class="zoomtools">
          <li class="zoomin" id="zoomin">Zoom in</li> <!--+-->
          <li class="zoomout" id="zoomout">Zoom out</li> <!---->
          <a id="fit" href="javascript:;" title="Reset"><img src="images/arrow_out.png"></a>
        </ul>
      </div>
    </div>
