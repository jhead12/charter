...
(function($) {
	...
	function initLoading(callback) {
		...
		if (galleryMode) {
			...
			$overlay.css("opacity", 0).show().fadeTo(500, settings.overlayOpacity, loading);
		}
	}
	...
	function showBox(curSettings) {
		...
		$superbox.fadeTo(500, 1, function(){
	...
	function createElements() {
		...
		// Add close button
		$closeBtn = $('<p class="close"><a href="javascript:;"><img src="lightbox/images/close.png" alt="close"/></a></p>').prependTo($superbox).find("a");
